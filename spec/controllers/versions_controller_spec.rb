  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved version as @version" do
        ...
        post :create, {:version => { "number" => "invalid value" }}, valid_session
        assigns(:version).should be_a_new(Version)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested version" do
        ...
        Version.any_instance.should_receive(:update).with({ "number" => "1" })
        put :update, {:id => version.to_param, :version => { "number" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the version as @version" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Version.any_instance.stub(:save).and_return(false)
        put :update, {:id => version.to_param, :version => { "number" => "invalid value" }}, valid_session
        assigns(:version).should eq(version)
      end
